...
extension Paths.Repos.WithOwner.WithRepo.Codespaces {
    ...
    public struct Secrets {
        ...
        public func get(perPage: Int? = nil, page: Int? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: makeGetQuery(perPage, page), id: "codespaces/list-repo-secrets")
        }

        public struct GetResponse: Decodable {
            public var totalCount: Int
            public var secrets: [GitHubAPI.RepoCodespacesSecret]

            public init(totalCount: Int, secrets: [GitHubAPI.RepoCodespacesSecret]) {
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.secrets = try values.decode([GitHubAPI.RepoCodespacesSecret].self, forKey: "secrets")
            }
        }
