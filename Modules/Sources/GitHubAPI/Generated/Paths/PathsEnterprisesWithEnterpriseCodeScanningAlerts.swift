...
extension Paths.Enterprises.WithEnterprise.CodeScanning {
    ...
    public struct Alerts {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<[GitHubAPI.CodeScanningOrganizationAlertItems]> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "code-scanning/list-alerts-for-enterprise")
        }
