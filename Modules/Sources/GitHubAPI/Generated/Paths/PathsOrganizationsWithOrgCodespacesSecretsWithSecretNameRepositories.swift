...
extension Paths.Organizations.WithOrg.Codespaces.Secrets.WithSecretName {
    ...
    public struct Repositories {
        ...
        public func get(page: Int? = nil, perPage: Int? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: makeGetQuery(page, perPage), id: "codespaces/list-selected-repos-for-org-secret")
        }
        ...
        public func put(selectedRepositoryIDs: [Int]) -> Request<Void> {
            Request(method: "PUT", url: path, body: ["selected_repository_ids": selectedRepositoryIDs], id: "codespaces/set-selected-repos-for-org-secret")
        }
    }
}
