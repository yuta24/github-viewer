...
extension Paths.Orgs.WithOrg.Dependabot.Secrets.WithSecretName.Repositories {
    ...
    public struct WithRepositoryID {
        ...
        public var put: Request<Void> {
            Request(method: "PUT", url: path, id: "dependabot/add-selected-repo-to-org-secret")
        }
        ...
        public var delete: Request<Void> {
            Request(method: "DELETE", url: path, id: "dependabot/remove-selected-repo-from-org-secret")
        }
    }
}
