...
extension Paths.Repos.WithOwner.WithRepo.Dependabot.Secrets {
    ...
    public struct WithSecretName {
        ...
        public var get: Request<GitHubAPI.DependabotSecret> {
            Request(method: "GET", url: path, id: "dependabot/get-repo-secret")
        }
        ...
        public func put(_ body: PutRequest) -> Request<Void> {
            Request(method: "PUT", url: path, body: body, id: "dependabot/create-or-update-repo-secret")
        }
        ...
        public var delete: Request<Void> {
            Request(method: "DELETE", url: path, id: "dependabot/delete-repo-secret")
        }
    }
}
