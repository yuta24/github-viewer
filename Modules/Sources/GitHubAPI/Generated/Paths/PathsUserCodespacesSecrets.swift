...
extension Paths.User.Codespaces {
    ...
    public struct Secrets {
        ...
        public struct GetResponse: Decodable {
            ...
            public var secrets: [GitHubAPI.CodespacesSecret]

            public init(totalCount: Int, secrets: [GitHubAPI.CodespacesSecret]) {
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.secrets = try values.decode([GitHubAPI.CodespacesSecret].self, forKey: "secrets")
            }
        }
