...
extension Paths.Repos.WithOwner.WithRepo.Codespaces.Secrets {
    ...
    public struct WithSecretName {
        ...
        public var get: Request<GitHubAPI.RepoCodespacesSecret> {
            Request(method: "GET", url: path, id: "codespaces/get-repo-secret")
        }
        ...
        public func put(_ body: PutRequest) -> Request<Void> {
            Request(method: "PUT", url: path, body: body, id: "codespaces/create-or-update-repo-secret")
        }
        ...
        public var delete: Request<Void> {
            Request(method: "DELETE", url: path, id: "codespaces/delete-repo-secret")
        }
    }
}
