...
extension Paths.Orgs.WithOrg.Actions {
    ...
    public struct Secrets {
        ...
        public struct GetResponse: Decodable {
            ...
            public var secrets: [GitHubAPI.OrganizationActionsSecret]

            public init(totalCount: Int, secrets: [GitHubAPI.OrganizationActionsSecret]) {
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.secrets = try values.decode([GitHubAPI.OrganizationActionsSecret].self, forKey: "secrets")
            }
        }
