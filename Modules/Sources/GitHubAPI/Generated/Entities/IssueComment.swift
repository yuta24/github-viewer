...
public struct IssueComment: Codable, Identifiable {
    ...
    public init(id: Int, nodeID: String, url: URL, body: String? = nil, bodyText: String? = nil, bodyHTML: String? = nil, htmlURL: URL, user: NullableSimpleUser? = nil, createdAt: Date, updatedAt: Date, issueURL: URL, authorAssociation: AuthorAssociation, performedViaGithubApp: NullableIntegration? = nil, reactions: ReactionRollup? = nil) {
        self.id = id
        self.nodeID = nodeID
        self.url = url
        self.body = body
