...
public struct LockedIssueEvent: Codable, Identifiable {
    public var id: Int
    ...
    public init(id: Int, nodeID: String, url: String, actor: SimpleUser, event: String, commitID: String? = nil, commitURL: String? = nil, createdAt: String, performedViaGithubApp: NullableIntegration? = nil, lockReason: String? = nil) {
        self.id = id
        self.nodeID = nodeID
        self.url = url
        self.actor = actor
