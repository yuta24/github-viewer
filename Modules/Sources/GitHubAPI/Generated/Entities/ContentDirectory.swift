...
public struct ContentDirectoryItem: Codable {
    ...
    public init(type: `Type`, size: Int, name: String, path: String, content: String? = nil, sha: String, url: URL, gitURL: URL? = nil, htmlURL: URL? = nil, downloadURL: URL? = nil, links: Links) {
        self.type = type
        self.size = size
        self.name = name
        self.path = path
