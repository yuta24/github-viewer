...
public struct ContentSubmodule: Codable {
    ...
    public init(type: `Type`, submoduleGitURL: URL, size: Int, name: String, path: String, sha: String, url: URL, gitURL: URL? = nil, htmlURL: URL? = nil, downloadURL: URL? = nil, links: Links) {
        self.type = type
